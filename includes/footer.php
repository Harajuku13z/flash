    ...
    <div class="container">
        <div class="footer-grid">
            <div class="footer-brand">
                <div class="footer-logo">FLASH</div>
                <p class="footer-tagline">TRANSPORT URBAIN.</p>
                <p class="footer-desc">FLASH connecte les propriétaires de taxis et les chauffeurs au Congo pour développer le business taxi.</p>
                <div class="footer-social">
                    <a href="https://wa.me/242000000000" class="social-btn whatsapp" target="_blank">
        ...
        <div class="footer-bottom">
            <p>&copy; <?= date('Y') ?> FLASH Transport Urbain. Tous droits réservés.</p>
            <p>Plateforme de recrutement de chauffeurs taxi au Congo</p>
        </div>
    </div>
</footer>
...
<a href="https://wa.me/242000000000?text=Bonjour%20FLASH%2C%20je%20souhaite%20des%20informations."
   class="whatsapp-float" target="_blank" rel="noopener" title="Contactez-nous sur WhatsApp">
